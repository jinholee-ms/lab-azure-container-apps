...
users.to_csv(assets_path / "users-kr.csv", index=False)
products.to_csv(assets_path / "products-kr.csv", index=False)
campaigns.to_csv(assets_path / "campaigns-kr.csv", index=False)
events.to_csv(assets_path / "events-kr.csv", index=False)
