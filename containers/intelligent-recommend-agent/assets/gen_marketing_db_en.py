...
users.to_csv("users-us.csv", index=False)
products.to_csv("products-us.csv", index=False)
campaigns.to_csv("campaigns-us.csv", index=False)
events.to_csv("events-us.csv", index=False)
